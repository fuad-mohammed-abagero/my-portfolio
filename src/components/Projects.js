                        ...
                        <Row>
                          <div>
                            ...
                            >
                              ...
                              Software Developer, I've had the privilege of
                              working on diverse and impactful projects that
                        ...
                        <div className="experience-section">
                          ...
                          <div className="experience-item-container">
                            ...
                            <p className="experience-description">
                              - Spearheaded the development of a customer
                              portal, resulting in a 20% increase in user
                              engagement.
                              <br />
                              ...
                              enhance the functionality of the company's
                              flagship product.
                            </p>
                          </div>
                          <div className="experience-item-container">
                            ...
                            <p className="experience-description">
                              ...
                              responsive websites for clients in diverse
                              industries.
                              <br />
                              - Conducted code reviews, identified
                              optimizations, and contributed to the successful
                              launch of three client websites.
                              <br />- Acquired hands-on experience with HTML,
                              CSS, and JavaScript.
                            </p>
                          </div>
                        </div>
